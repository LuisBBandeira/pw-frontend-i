...
template.innerHTML = `
    ...
    <div class="gallery">
        ...
        <slot name ="toggle-button">NEDD TOGGLE BUTTON</slot>
...
class WebGallery extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.shadowRoot.querySelector('slot').addEventListener = ('toggle' ,(ev) => {
            this.#playPause();
...
<div id="icons-container">
    ...
    <svg opacity="0" width="58" height="64" version="1.1" viewBox="0 0 58 64" xmlns="http://www.w3.org/2000/svg">
